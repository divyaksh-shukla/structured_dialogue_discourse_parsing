...
cp stac/relation_database.json convin/relation_database.json
...
python parse_test.py --dir_path convin --num_contexts 14 --mode dev $1
python parse_test.py --dir_path convin --num_contexts 14 $1
