...
class Model(nn.Module):
    ...
    def forward(self, context_pair_input_ids, context_pair_input_masks, type_ids, context_sentence_masks, labels, max_sent_len=None):
        ...
        # TODO: Save the context_pair_input_ids, potentials, labels, single_tree_score, log_partition, log_prob for each instance in a batch using a dictionary essentially by running a for loop on batch.shape[0]
        return -log_prob
